...
def build_ins(args):
    ...
    if args.paths_absolute=='True' or args.paths_absolute=='true':
        args.riet_analysis_file = os.path.join(args.work_dir,args.run_dir,args.sub_dir,args.riet_analysis_file)        
        args.riet_analysis_fileToSave = os.path.join(args.work_dir,args.run_dir,args.sub_dir,args.riet_analysis_fileToSave)    
        args.riet_append_result_to = os.path.join(args.work_dir,args.run_dir,args.sub_dir,args.riet_append_result_to)  
        args.riet_append_simple_result_to = os.path.join(args.work_dir,args.run_dir,args.sub_dir,args.riet_append_simple_result_to)  
        if args.maud_export_pole_figures_filename!=None:
            args.maud_export_pole_figures_filename = os.path.join(args.work_dir,args.run_dir,args.sub_dir,args.maud_export_pole_figures_filename)  
            args.maud_export_pole_figures = " ".join(args.maud_export_pole_figures)
        if args.maud_output_plot2D_filename!=None:
            args.maud_output_plot2D_filename = os.path.join(args.work_dir,args.run_dir,args.sub_dir,args.maud_output_plot2D_filename)  
        args.ins_file_name = os.path.join(args.work_dir,args.work_dir,args.run_dir,args.sub_dir,args.ins_file_name) 
        ...
        if args.maud_LCLS2_Cspad0_original_image!=None:
            if 'search' in args.maud_LCLS2_Cspad0_original_image[0]:
                ...
                for i in range(0,len(wild)):
                    fullpath=os.path.join(args.work_dir[i][0],args.run_dir[i][0],args.sub_dir[i][0])
