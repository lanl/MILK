...
from MILK.environment.initilize import loadini
import os 
import sys
...
resourceList=['MILK/interface/model/resources','MILK/MAUDText/resources','resources','MILK/environment/resources']
