...
if __name__ == '__main__':
    ...
    editor.set_val(key='_riet_par_gaussian_value',value='0.3',loopid='0')
    editor.set_val(key='_riet_par_gaussian_value',value='0.0',loopid='1')
    # editor.set_val(key='_riet_par_caglioti_value',value='0.0')
    editor.set_val(key='_riet_par_caglioti_value',value='0.001',loopid='0')
    editor.set_val(key='_riet_par_caglioti_value',value='0.06',loopid='1')
    editor.set_val(key='_riet_par_caglioti_value',value='0.0',loopid='2')
    maudText.refinement(itr='4', ifile=editor.ifile,ofile=editor.ofile,simple_call=True)
    ...
    maudText.refinement(itr='4', ifile=editor.ifile,ofile=editor.ofile,simple_call=True)
    editor.fix(key='_pd_instr_dist_spec/detc')
    editor.free(key='_inst_ang_calibration_center_x')
    maudText.refinement(itr='4', ifile=editor.ifile,ofile=editor.ofile,simple_call=True)
    editor.fix(key='_inst_ang_calibration_center_x')
    ...
    editor.fix(key='_pd_instr_dist_spec/detc')
    editor.fix(key='_inst_ang_calibration_center_x')
    editor.fix(key='_inst_ang_calibration_center_y')
    ...
    editor.free(key='_riet_par_gaussian_value',loopid='1')
    maudText.refinement(itr='4', ifile=editor.ifile,ofile=editor.ofile,simple_call=True)
